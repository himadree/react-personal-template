...
import aboutImg from '../component/img/about-img.png'
import cLogo from '../component/img/about/c-logo.png'
import user1 from '../component/img/elements/user1.png'
import user2 from '../component/img/elements/user2.png'
import l1 from '../component/img/l1.png'
import l2 from '../component/img/l2.png'
import l3 from '../component/img/l3.png'
import l4 from '../component/img/l4.png'
import l5 from '../component/img/l5.png'
import './css/main.css';
      ...
      <div>
        ...
        <section class="timeline pb-120">
          <div class="text-center">
            ...
            <li>
              <div class="content">
              <img class="img-fluid mx-auto d-block mb-30" src={cLogo} alt="" />
              <h4>
		            ...
		            <div class="row">
		                <div class="active-testimonial">
		                    <div class="single-testimonial item d-flex flex-row">
		                        <div class="thumb">
		                            <img class="img-fluid" src={user1} alt="" />
		                        </div>
		                        <div class="desc">
		                            <p>
		                    ...
		                    <div class="single-testimonial item d-flex flex-row">
		                        <div class="thumb">
		                            <img class="img-fluid" src={user2} alt="" />
		                        </div>
		                        <div class="desc">
		                            <p>
		            ...
		            <div class="brand-wrap">
		                <div class="row align-items-center active-brand-carusel justify-content-start no-gutters">
		                    <div class="col single-brand">
		                        <a href="#"><img class="mx-auto" src={l1} alt="" /></a>
		                    </div>
		                    <div class="col single-brand">
		                        <a href="#"><img class="mx-auto" src={l2} alt="" /></a>
		                    </div>
		                    <div class="col single-brand">
		                        <a href="#"><img class="mx-auto" src={l3} alt="" /></a>
		                    </div>
		                    <div class="col single-brand">
		                        <a href="#"><img class="mx-auto" src={l4} alt="" /></a>
		                    </div>
		                    <div class="col single-brand">
		                        <a href="#"><img class="mx-auto" src={l5} alt="" /></a>
		                    </div>
		                </div>
		            </div>
		        </div>
